...
class Solution {
    ...
    public ListNode addTwoNumbers(ListNode l1, ListNode l2) {
        ...
        l1 = reverseList(l1); // Asked to revese and then add in this question
        l2 = reverseList(l2); // Asked to revese and then add in this question
        ...
        return reverseList(dummy.next); // Reverse at last also
    }
