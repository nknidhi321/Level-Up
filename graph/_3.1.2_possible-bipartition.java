        ...
        while(!queue.isEmpty()) {
            ...
            while(size-- > 0) {
                ...
                if(visOrColor[currVtx] != -1) { 
                    if(visOrColor[currVtx] != color) { // Already visited with different color => Conflict
                        return false; // That's the end return 
                    }
					// Already visited with same color => No conflict => Further process your BFS   
